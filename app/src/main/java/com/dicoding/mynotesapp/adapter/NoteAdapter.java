...
/*
    ...
    * Viewgroup berupa RecyclerView dengan data yang berasal dari obyek linkedlist bernama listNotes
 */
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, int position) {
        ...
        // implementasi dari CustomOnItemClickListener yang membuat obyek CardViewNote bisa diklik untuk mengarahkan ke halaman NoteAddUpdateActivity
